...
| --- | --- |
| Language and packaging | Python 3.11+, with dependencies and run/verification instructions owned by this repository. This independent repository is checked out at ~/Projects/threat-hunting-harness, alongside the workshop repository. |
